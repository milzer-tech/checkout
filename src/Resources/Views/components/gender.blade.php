@php use Nezasa\Checkout\Integrations\Nezasa\Enums\GenderEnum;use Nezasa\Checkout\Supporters\AutoCompleteSupporter; @endphp
<div class="space-y-2 w-full min-w-0">
    <label
        class="block text-gray-700 dark:text-gray-200 font-medium overflow-ellipsis whitespace-nowrap overflow-hidden">
        {{trans('checkout::input.attributes.gender')}}@if($isRequired)
            *
        @endif
    </label>
