<div class="grid grid-cols-2 lg:grid-cols-3 gap-6 min-w-0 mt-6">
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.street1" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.street2" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.postalCode" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.city" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.country" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.countryCode" class="form-input w-full"
    ...
    <div class="space-y-2 w-full min-w-0">
        ...
        <input type="text" wire:model="{{$wireModel}}.region" class="form-input w-full"
