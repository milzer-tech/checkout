...
{{trans('checkout::page.trip_details.rest_payment_will_be_payable_later')}}
        ...
        <!-- Payment method -->
        <div class="space-y-4">
            <h3 class="text-base font-semibold text-gray-900">{{trans('checkout::page.trip_details.select_payment_methods')}}:</h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                @foreach($options as $option)
                    <label class="relative cursor-pointer payment-option">
                        ...
                        <style>
                            .payment-option input:checked + div .dot { opacity: 1; }
                        </style>
                    </label>
                @endforeach
            </div>
