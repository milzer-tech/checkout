    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <label class="border border-blue-700 rounded-xl px-4 py-2 flex items-center gap-2 cursor-pointer hover:shadow-sm w-full h-[48px]">
                <input type="radio" wire:click="select('{{$option->name}}')" @checked($option->isSelected)
        ...
        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <p class="text-gray-600 dark:text-gray-300">You will be redirected to ... to complete your payment.</p>
        </div>
    </div>
</x-checkout::editable-box>
