...
class ItinerarySummary extends BaseDto
{
    ...
    {
        return $this->stays->reject(fn (ItineraryStay $stay): bool => (bool) $stay->availability?->isBooked());
    }
    ...
    {
        return $this->activities->reject(fn (ItineraryActivity $activity): bool => (bool) $activity->availability?->isBooked());
    }
    ...
    {
        return $this->upsellItems->reject(fn (UpsellItem $upsellItem): bool => (bool) ($upsellItem->availability?->isBooked()));
    }
}
