...
use Nezasa\Checkout\Integrations\HanseMerkur\Resources\HanseMerkurPaymentResource;
 ...
 */
class HanseMerkurPaymentConnector extends Connector implements ConfiguresLogging, HasBody
{
    use HasJsonBody;
    use HasLogging;
    use Makeable;
    ...
    public function configureLogging(LoggingOptions $options, PendingRequest $pendingRequest): LoggingOptions
    {
        return $options->withOutgoingMessages(
            request: 'checkout-to-hansemerkur-payment',
            response: 'hansemerkur-payment-to-checkout',
            failure: 'hansemerkur-payment-failed',
        );
    }
    ...
    {
        return Config::string('checkout.insurance.hanse_merkur.payment_base_url');
    }
    ...
    public function payment(): HanseMerkurPaymentResource
    {
        return new HanseMerkurPaymentResource($this);
    }
}
