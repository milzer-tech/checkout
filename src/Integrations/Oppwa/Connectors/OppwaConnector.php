...
class OppwaConnector extends Connector
{
    ...
    {
        return Config::string('checkout.integrations.oppwa.base_url');
    }
    ...
    {
        return [
            'entityId' => Config::string('checkout.integrations.oppwa.entity_id'),
        ];
    }
    ...
    {
        return new TokenAuthenticator(Config::string('checkout.integrations.oppwa.token'));
    }
