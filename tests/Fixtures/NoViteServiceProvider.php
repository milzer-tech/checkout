    ...
    public function register(): void
    {
        ...
        $this->app->singleton(LaravelVite::class, function () {
            return new class
            {
                ...
                public function useBuildDirectory($dir = 'build')
                {
                    return $this;
                }

                public function useManifest($path)
                {
                    return $this;
                }

                public function useScriptTagAttributes($value)
                {
                    return $this;
                }

                public function useStyleTagAttributes($value)
                {
                    return $this;
                }

                public function cspNonce(?string $nonce)
                {
                    return $this;
                }
